...
impl WeightInfo for () {
    ...
    /// Storage: `Poe::Values` (r:354 w:352)
    ...
    fn publish_attestation() -> Weight {
        ...
        //  Measured:  `35164`
        //  Estimated: `902628`
        // Minimum execution time: 799_352_000 picoseconds.
        Weight::from_parts(847_626_000, 902628)
            .saturating_add(RocksDbWeight::get().reads(356_u64))
            .saturating_add(RocksDbWeight::get().writes(354_u64))
    }
}