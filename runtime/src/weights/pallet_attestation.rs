...
//! HOSTNAME: `8f1ffbe2675d`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
// --output
// /data/benchmark/runtime/src/weights/pallet_attestation.rs
// --template
...
/// Weights for `pallet_attestation` using the zkVerify node and recommended hardware.
pub struct ZKVWeight<T>(PhantomData<T>);

impl<T: frame_system::Config> pallet_attestation::WeightInfo for ZKVWeight<T> {
    /// Storage: `Attestation::NextAttestation` (r:1 w:1)
    /// Proof: `Attestation::NextAttestation` (`max_values`: Some(1), `max_size`: Some(8), added: 503, mode: `MaxEncodedLen`)
    /// Storage: `Attestation::Values` (r:33 w:0)
    ...
    fn publish_attestation() -> Weight {
        ...
        Weight::from_parts(86_432_000, 85041)
