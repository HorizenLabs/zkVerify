...
//! Autogenerated weights for `pallet_settlement_risc0`
//!
...
// Executed Command:
// /home/giacomo/Programming/NH-core/target/production/nh-node
// benchmark
// pallet
// --chain
// dev
// --pallet
// pallet-settlement-risc0
// --extrinsic
// *
// --steps
// 50
...
// --heap-pages=4096
// --header
// /home/giacomo/Programming/NH-core/HEADER-APACHE2
// --output
// runtime/src/weights/pallet_settlement_risc0.rs
// --template
...
/// Weights for `pallet_settlement_risc0` using the New Horizen node and recommended hardware.
pub struct NHWeight<T>(PhantomData<T>);

impl<T: frame_system::Config> pallet_settlement_risc0::WeightInfo for NHWeight<T> {
    ...
    fn submit_proof() -> Weight {
        ...
        //  Measured:  `74`
        //  Estimated: `3537`
        // Minimum execution time: 13_508_185_000 picoseconds.
        Weight::from_parts(13_898_553_000, 3537)
