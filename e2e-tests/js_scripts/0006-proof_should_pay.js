...
async function run(nodeName, networkInfo, args) {
    ...
    if (await submitProof(api.tx.settlementFFlonkPallet, alice, VALID_PROOF, null) == -1) {
    ...
    if (await submitProof(api.tx.settlementFFlonkPallet, alice, INVALID_PROOF, null) !== -1) {
